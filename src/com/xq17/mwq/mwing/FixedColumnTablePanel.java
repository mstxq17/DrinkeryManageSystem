...
public class FixedColumnTablePanel extends JPanel {
    ...
    public FixedColumnTablePanel(Vector<String> tableColumnV, Vector<Vector<Object>> tableValueV, int fixedColumn) {
        super();
        ...
        scrollPane.setCorner(ScrollPaneConstants.UPPER_LEFT_CORNER, fixedColumnTable.getTableHeader()); // 将固定列表格头放到滚动面版的左上方
    ...
    class MTable extends JTable {
         ...
         * 
         */
        private static final long serialVersionUID = -979863123121986924L;
